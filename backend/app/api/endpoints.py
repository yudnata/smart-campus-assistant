...
async def ingest_file_endpoint(
    ...
    if file.filename.endswith(".pdf"):
        try:
            chunks_added = ingest_pdf(content, file.filename, db, prodi, bab)
        ...
        try:
            chunks_added = ingest_csv(content, file.filename, db, prodi, bab)
        ...
        try:
            chunks_added = ingest_json(content, file.filename, db, prodi, bab)
